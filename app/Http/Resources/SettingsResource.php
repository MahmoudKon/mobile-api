...
class SettingsResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'edit_sale_price'         => authUser()->sale_price ?? 0,
            'telephone_required'      => $this->telephone_required ?? 0,
            'client_address_required' => $this->client_address_required ?? 0,
            'return_sales_insert'     => authUser()->return_sales_insert ?? 0,
        ];
    }
}
