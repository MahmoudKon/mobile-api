...
class ClientReceiptController extends BasicApiController
{
    ...
    {
        $rows = ClientTransaction::select( 'id', 'amount', 'type', 'pay_day', 'balance', 'bill_id', 'client_id', 'date_time')->perClient($client_id)->with('invoice', 'client')->whereIn('type', [0, 1, 2, 4, 8, 9])->get();
